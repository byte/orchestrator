...
test("the resume command restores durable state and keeps Fable in authority", () => {
  const command = fs.readFileSync(
  ...
  assert.match(command, /Claude Fable remains the planner, scheduler, reviewer, replanner, integrator/);
